...
extension ScanningViewController {
    ...
    private func addNode(to node: SCNNode, for anchor: ARAnchor, work: Work) {
        ...
        let textLabelNode = TextLabelNode(groupId: textLabelNodeGroupId, text: work.title, originalPosition: SCNVector3(0, 0.3, -0.3), textColor: .white, width: 1.0, extrusionDepth: 1.0)
